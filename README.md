...
- **Categories with more discounts applied in one channel but no corresponding increase in sales warrant further investigation.** Beverage, Food and Furniture have more in-store discounts yet online sales perform better, implying that the discounts may not be attractive enough or misaligned with customer behaviour. Discounts should be reduced if the return on investment is too low and be replaced with store-exclusive bundles or improving in-store experiences such as sampling.
