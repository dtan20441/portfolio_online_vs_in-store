...
## Recommendations
- The **cause of spike in sales from both channels in certain months should be investigated and replicated** to sustain or improve high levels of sales. Alternatively, holiday or seasonal specials with limited time products should be implemented to encourage spending.
...
- **Categories with more discounts applied in one channel but no corresponding increase in sales should have discounts reduced or replaced if they are ineffective.** Beverage, Food and Furniture have more in-store discounts yet online sales perform better, implying that the discounts may not be attractive enough. Focus should be on improving in-store experiences such as sampling or have store-exlcusive bundles which may also increase the purchasing frequence of in-store shoppers. 
