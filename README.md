...
- **Categories with more discounts applied in one channel but no corresponding increase in sales should have discounts reduced or replaced if they are ineffective.** Beverage and Food have more in-store discounts yet online sales perform better. Thus, focus should be on improving in-store experiences such as sampling or have store-exlcusive bundles which may also increase the purchasing frequencey of in-store shoppers. 
